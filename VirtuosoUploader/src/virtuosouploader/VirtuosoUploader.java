...
/**
 * Programas para subir datos directamente a virtuoso
 *
 * @author Victor
 */
public class VirtuosoUploader {
     ...
     *
     * SELECT * WHERE { GRAPH <http://tbx2rdf.lider-project.eu/> { ?s ?p ?o } }
     * limit 100
     *
     *
     */
    public static void uploadLargeFile() {
        File file = new File("mini.nt");
        try {
    ...
    public static void subir(String graph, String pack) {
        try {
